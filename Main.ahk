...
ShowWelcome:
    ...
    Gui, 99: Margin, 10, 10
    Gui, 99: Add, Picture, x10 y0 w768 h432, %A_ScriptDir%\Images\welcome.jpg
    Gui, 99: Add, Button, x240 y+10 w300 h40 gContinue, Continue
    Gui, 99: Show, w788 h492 Center, Virage Grow a Garden Macro [COSMETIC UPDATE] (pom crack)
return
...
ShowVerify:
    ...
    Gui, 2: Add, Text, x10 y10 w380 h40 Center, just click the verify button lol
    Gui, 2: Font, s9 cWhite, Segoe UI
    Gui, 2: Add, Button, x50 y60 w120 h30 gVerifyUser, also verify
    Gui, 2: Add, Button, x210 y60 w120 h30 gVerifyUser, Verify
    Gui, 2: Show,  w400 h110 Center, goofy ass verification
Return
...
VerifyUser:
    if (triedVerify = 0) {
               MsgBox, 0x41030, wait one sec twn, then try it again.
        triedVerify := 1
    } else {
        Gui, 2: Destroy
        Gui, 99: Destroy
...
Gui, Add, Button, x400 y140 w85 h18 gSavePrivateURL Background202020, Save Link
    ...
    Gui, Add, Text, x100 y96 w200 h16, cracked ts shi
    Gui, Font, s8 cWhite, Segoe UI
    Gui, Add, Text, x40 y130 w200 h40, im sippin like drank drank drank drank... im a badass fuckin kid...

    Gui, Font, s9 cWhite Bold, Segoe UI
    Gui, Add, Text, x40 y200 w200 h20, this guys yap ass tutorials:
    Gui, Font, s8 cD3D3D3 Underline, Segoe UI
    Gui, Add, Link, x40 y244 w300 h16,  Check the <a href="https://github.com/VirageRoblox/Virage-Grow-A-Garden-Macro/releases/latest">Github</a> for the latest macro updates! (ill crack these eventually)
    Gui, Add, Link, x40 y264 w300 h16, Watch the latest macro <a href="https://youtu.be/L6GsrZYjECY">tutorial</a> on Youtube!
  



    Gui, Show, w520 h425, Virage Grow a Garden Macro [BIZZY BEE UPDATE] (pom crack)
